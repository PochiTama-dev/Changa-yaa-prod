...
export default [
  ...
  body('pass').custom((value, {req}) => value !== req.body.pass2 ? false : true)
    .bail()
  ...
  check('pass2')
    ...
    .notEmpty()
    .bail()
    .withMessage('Repita la contraseña anterior para confirmar.').bail(),

  body('pass2').custom((value, {req}) => value !== req.body.pass ? false : true)
    .bail()
    .withMessage('Debe confirmar la contraseña repitiendola aquí.'),
